...
- tape path: full 1536x1024 transparent PNG, visible alpha confined to `x=704..839`, `y=284..381`; it contains the two static tape strands and remains behind the rotating reels and shell;
...
The two tape strands are static mechanism geometry. They do not rotate with the reels. They leave the visible wound-tape area, descend toward the lower tape route and disappear before/under the exact foreground support.
...
- `cassette-tape-path.png`: `d07df8c970ca8a497d36814c9be6d6433cf383b9b18e61f2b7fe18ea727bc3a6`

...
# The project maintains deployed CSS directly. Do not resurrect references to the
# retired generator/source layout unless that pipeline is restored in the same change.
